...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The underlying PersonQueue was implementing a Stack (LIFO) instead of a Queue (FIFO).
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The person with 0 turns (infinite) was not re-enqueued correctly in the initial implementation.
    ...
    // Defect(s) Found: The person with negative turns (infinite) was not being handled as infinite turns.
    ...
    // Defect(s) Found: None. The code correctly identifies an empty queue and throws the required exception.
